...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(PARAVIEWO_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  paraviewo_filter_flags(PARAVIEWO_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${PARAVIEWO_GLOBAL_FLAGS}")
  add_compile_options(${PARAVIEWO_GLOBAL_FLAGS})
endif()
